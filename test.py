...
AIPROJECT_CONNECTION_STRING = os.getenv("https://aif-amyaifoundry.services.ai.azure.com/api/projects/firstProject")
AGENT_ID = os.getenv("asst_HkPiz9n1tnB9VHJ7YckpGW76")
